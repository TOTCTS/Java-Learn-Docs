...
<div style="text-align: center; margin: 20px 0; padding: 20px; background: #fafbfc; border: 1px solid #e1e5e9; border-radius: 8px;">
  ...
  <img src="/assets/java/jvm/jvm-memory-structure-diagram.svg" alt="JVM 运行时数据区架构图" style="max-width: 100%; height: auto; border-radius: 4px;" />
</div>
...
<div style="text-align: center; margin: 20px 0; padding: 20px; background: #fafbfc; border: 1px solid #e1e5e9; border-radius: 8px;">
  ...
  <img src="/assets/java/jvm/object-allocation-flowchart.svg" alt="Java 对象分配与晋升流程图" style="max-width: 100%; height: auto; border-radius: 4px;" />
</div>
