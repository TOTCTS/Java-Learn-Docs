...
<div style="text-align: center; margin: 20px 0; padding: 20px; background: #fafbfc; border: 1px solid #e1e5e9; border-radius: 8px;">
  <img src="/assets/java/jvm/object-model-overview.svg" alt="Java 对象模型核心概览" style="max-width: 100%; height: auto; border-radius: 4px;" />
</div>
...
<div style="text-align: center; margin: 20px 0; padding: 20px; background: #fafbfc; border: 1px solid #e1e5e9; border-radius: 8px;">
  ...
  <img src="/assets/java/jvm/object-creation-flowchart.svg" alt="Java 对象创建流程图" style="max-width: 100%; height: auto; border-radius: 4px;" />
</div>
...
<div style="text-align: center; margin: 20px 0; padding: 20px; background: #fafbfc; border: 1px solid #e1e5e9; border-radius: 8px;">
  ...
  <img src="/assets/java/jvm/object-memory-layout.svg" alt="HotSpot虚拟机对象内存布局图" style="max-width: 100%; height: auto; border-radius: 4px;" />
</div>
...
<div style="text-align: center; margin: 20px 0; padding: 20px; background: #fafbfc; border: 1px solid #e1e5e9; border-radius: 8px;">
  ...
  <img src="/assets/java/jvm/object-access-comparison.svg" alt="对象访问方式对比图" style="max-width: 100%; height: auto; border-radius: 4px;" />
</div>
